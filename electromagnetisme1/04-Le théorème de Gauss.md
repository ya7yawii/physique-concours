...
> [!note] Calcul d'un champ électrostatique à l'aide du théorème de Gauss : Distribution à symétrie sphérique
> L'exemple type traité correspond à une charge volumique $\rho$ distribuée uniformément à l'intérieur d'une boule de centre $O$ et de rayon $R$. Nous noterons : $q = \frac{4}{3}\pi R^{3}\rho$ la charge totale de cette boule ([[#^figure11|fig. 11]]).
> - Première étape : utilisation des symétries de la distribution :
> Considérant deux plans perpendiculaires $\Pi_1$ et $\Pi_2$ contenant le centre de symétrie $O$ et le point $M$ où nous cherchons à déterminer le champ, nous obtenons en coordonnées sphériques $\overrightarrow{E}(r, \theta, \varphi) = E(r, \theta, \varphi)\overrightarrow{e}_r$ ([[#^figure11|fig. 11]]).
> L'invariance de la distribution par rotation autour de tout axe contenant le centre $O$ apporte la simplification $\overrightarrow{E}(r, \theta, \varphi) = E(r)\overrightarrow{e}_r$.
> - Deuxième étape : choix de la surface de Gauss :
> La surface fermée adaptée à cette géométrie est naturellement une sphère de centre $O$ et de rayon $r$. Le flux du champ à travers cette surface est $\Phi = 4\pi r^{2}E(r)$.
> - Troisième étape : application du théorème de Gauss :
> La charge intérieure à cette surface est : $Q_{int} = \frac{4}{3}\pi r^{3}\rho$, si $r < R$ et $Q_{int} = \frac{4}{3}\pi R^{3}\rho$, si $r > R$.
> Nous obtenons ainsi le champ continu de cette distribution volumique :
> 	- $r \leqslant R$ : $\overrightarrow{E} = \frac{\rho r}{3\epsilon_0}\overrightarrow{e}_r = \frac{q}{4\pi\epsilon_0}\frac{r}{R^{3}}\overrightarrow{e}_r$ ;
> 	- $r \geqslant R$ : $\overrightarrow{E} = \frac{\rho R^{3}}{3\epsilon_0r^{2}}\overrightarrow{e}_r = \frac{q}{4\pi\epsilon_0}\frac{1}{r^{2}}\overrightarrow{e}_r$.
> 	*Notons qu'à l'extérieur de la boule chargée, le champ créé est identique à celui d'une charge $q$ placée au centre de la sphère.*
> 	*Remarque : $\rho$ étant fini, le champ est partout continu et défini, même pour $r = R$.*
> 	
> Le potentiel, continu en $r = R$, s'en déduit :
> - $r \leqslant R$ : $V(r) = \frac{\rho(3R^{3} - r^{2})}{6\epsilon_0} + V_0 = \frac{q}{4\pi\epsilon_0}\frac{3R^{2} - r^{2}}{2R^{3}} + V_0$ ;
> - $r \geqslant R$ : $V(r) = \frac{\rho R^{3}}{3\epsilon_0 r} + V_0 = \frac{q}{4\pi\epsilon_0}\frac{1}{r} + V_0$.
> 
> Aucune charge ne se trouvant à l'infini, nous pouvons convenir que $V (r \rightarrow \infty) = 0$ d'où $V_0 = 0$.
> $E(r)$ et $V(r)$ sont représentés sur la [[#^figure12|figure 12]].
> - Cas d'une distribution de masses :
> Le cas d'une distribution de masses à symétrie sphérique se traite de façon analogue. Notons $\mu$ la masse volumique uniforme à l'intérieur d'une sphère de rayon $R$ et $m = \frac{4}{3}\pi R^{3}\mu$ la masse totale de cette sphère. En remplaçant $q$ par $m$ et $K = \frac{1}{4\pi\epsilon_0}$ par $-G$, il vient :
> 	- Champ créé par cette distribution volumique :
> 	$r \leqslant R$ : $\overrightarrow{E}_g = -\frac{4\pi G}{3}\mu r\overrightarrow{e}_r = -Gm\frac{r}{R^{3}}\overrightarrow{e}_r$.
> 	$r \geqslant R$ : $\overrightarrow{E}_g = -\frac{4\pi G}{3}\mu \frac{R^{3}}{r^{2}}r\overrightarrow{e}_r = -Gm\frac{1}{r^{2}}\overrightarrow{e}_r$.
> 	- Potentiel créé par la sphère :
> 	$r \leqslant R$ : $V = -\frac{2\pi G}{3}\mu(3R^{2} - r^{2}) + V_0 = -Gm\frac{(3R^{2} - r^{2})}{2R^{2}} + V_0$.
> 	$r \geqslant R$ : $V = -\frac{4\pi G}{3}\mu \frac{R^{3}}{r} + V_0 = -Gm\frac{1}{r} + V_0$.
> 	
> 	À l'extérieur de la sphère, le champ et le potentiel de gravitation sont identiques à ceux créés par une masse $m$ placée au centre de la sphère.
# Définitions
...
Surface de Gauss sphérique par une distribution à symétrie sphérique
![[electromagnetisme1/attachments-electromagnetisme1/figure52.png]]^figure11
# Graphiques
...
Champ et potentiel d'une boule chargée
![[electromagnetisme1/attachments-electromagnetisme1/figure53.png]]^figure12
# Expériences
